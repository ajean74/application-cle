        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav justify-content-end">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active black" href="clecommun.php">Clé des Communs</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="ajout-button">
                        <a href="../Commun.php" class="btn btn-outline-primary">Ajouter une clé</a>
                    </div>
                        ...
                        <table id="exemple" class="table table-bordered cell-border table-striped" style="width:95%">
                            <thead>
                                ...
                                <tr class="bg-head-tableau">
                                    <th>N° Copro</th>
                                    <th>Nom Copro</th>
                                    <th>Intitulé de la Clé + Photo</th>
                                    <th>Disponibilité</th>
                            ...
                            <tbody class="bg-tableau">
                                ...
                                <?php
                                    ...
                                    $data = $db->query("SELECT * FROM CleCommun")->fetchAll();
                                    ...
                                    foreach($data as $row){
                                        ...
                                        echo"<td class='black text-left'>";
                                        foreach($data2 as $numcop){
                                            if($row['Copro'] == $numcop['id']){
                                                echo $numcop['NumCopro'];
                                            }
                                        }
                                        ...
                                        if ($row['Photo'] == NULL){
                                            echo"</td><td class='black text-left' width=30%>".$row['Intitule']."</td>";
                                        }
                                        else{
                                            echo "</td><td class='black text-left'><a class='black' target='_blank' href='../".$row['Photo']."' type='submit'>".$row['Intitule']."</a></td>";
                                        }
                                        echo"<td class='black text-left'>";
                                        ...
                                        foreach($data5 as $loc){
                                            if($row['Agence'] == $loc['id']){
                                                if($row['Etat'] == 2){
                                                    foreach($data6 as $user){
                                                        if($row['Utilisateur'] == $user['id']){
                                                            echo "<a class='black' href='clecommun.php?info=".$row['id']."&1=".$row['NomPersonne']."&2=".$row['Date']."&3=".$row['Contact']."&4=".$user['Prenom']."&5=".$row['DateRetour']."&8=".$row['Note']."'>".$loc['Nom']."</a>";
                                                        }
                                                    }
                                                ...
                                                elseif($row['Etat'] == 3){
                                                    foreach($data6 as $user){
                                                        if($row['Utilisateur'] == $user['id']){
                                                            echo "<a class='black' href='clecommun.php?note=".$row['id']."&1=".$row['NomPersonne']."&2=".$row['Date']."&3=".$row['Contact']."&4=".$user['Prenom']."&5=".$row['Note']."&6=".$row['DateRetour']."'>".$loc['Nom']."</a>";
                                                        }
                                                    }
                                        ...
                                        echo"</td>";
                                        echo"<td class='text-center'><div><a href='clecommun.php?rs=".$row['id']."'><input class='btn btn-outline-primary' name='lebouton' type='button' value='Interagir' id='Sortir'></a></div></td>";

                                        echo"<td class='text-center'><a href='../Historique.php?update=".$row['id']."&cle=".$row['Intitule']."'><img src='../image/histo.png' width='30px'></a></td>";

                                        echo"<td class='text-center'><a href='../Commun.php?update=".$row['id']."&cle=".$row['Intitule']."&ncop=".$row['Copro']."&cl=".$row['Client']."&ag=".$row['Agence']."&pj=".$row['Photo']."'><img src='../image/Edit.png' width='30px'></a></td>";

                                        echo"<td class='text-center'><a href='clecommun.php?delete=".$row['id']."'><img src='../image/Poubelle.png' width='30px'></a></td></tr>";
                                        /* --- Info ---*/
                                        ...
                                        if (isset($_GET['info'])){
                                            echo '<div class="popup text-center" id="popup">
                                                    <div class="body arrondi7 p-3">
                                                        ...
                                                        </b></p><p>Date prévisionnelle de retour le <b>'.$_GET['6'].'</b></p><p>De plus voici la note ajoutée à cette clé : <b>'.$_GET['8'].'</b></p></div>
                                                        <div class="form-group">
                                                            <a href="clecommun.php?info='.$_GET['info'].'&annuler=1" class="btn btn-outline-primary mx-3" id="annuler">Annuler</a>
                                                        </div>
                                                    </div>
                                                </div>';
                                            ...
                                            if(isset($_GET['annuler'])){
                                                if($_GET['annuler'] == 1){
                                                    ...
                                                    window.location.replace("clecommun.php");</script>';
                                                }
                                            }
                                        }
                                            ...
                                            echo '<div class="popup text-center" id="popup">
                                                    <div class="body arrondi7 p-3">
                                                        <div>
                                                            <h2>Information sur cette clé</h2>
                                                            <p>Cette clé a été sortie le <b>'.$_GET['2'].'</b> par <b>'.$_GET['4'].'</b> pour <b>'.$_GET['1'].'</b> et voici comment la contacter <b>'.$_GET['3'].'
                                                        </b></p><p>Date prévisionnelle de retour le <b>'.$_GET['5'].'</b></p><p>De plus voici la note ajoutée à cette clé : <b>'.$_GET['5'].'</b></p></div>
                                                        <div class="form-group">
                                                            <a href="clecommun.php?info='.$_GET['info'].'&annuler=1" class="btn btn-outline-primary btn-annuler mx-3" id="annuler">Annuler</a>
                                                        </div>
                                                    </div>
                                                </div>';
                                            echo '<script src="../js/index.js"></script>';
                                        ...
                                        if (isset($_GET['delete'])){
                                            ...
                                            <a href="clecommun.php?delete='.$_GET['delete'].'&valider=1" class="btn btn-outline-primary mx-3" id="valider">Supprimer</a>
                                            <a href="clecommun.php?delete='.$_GET['delete'].'&annuler=1" class="btn btn-outline-primary mx-3" id="annuler">Annuler</a>
                                            </div>
                                            </div>
                                            </div>';
                                            echo '<script src="../js/index.js"></script>';
                                            if(isset($_GET['valider'])){
                                                if($_GET['valider'] == 1){
                                                    $idUser = $_GET['delete'];
                                                    $db = new PDO('mysql:host=clesgrn1.mysql.db;dbname=clesgrn1;charset=utf8mb4', 'clesgrn1', 'Grosset74');
                                                    $stmt = $db->prepare("DELETE FROM CleCommun WHERE id = :idUserDelete");
                                    ...
                                    /* --- Bouton Rentrer Sortir ---*/
                                        ...
                                        if (isset($_GET['rs'])){
                                            $id2 = $_GET['rs'];
                                            $data111 = $db->query("SELECT * FROM CleCommun WHERE id = $id2")->fetchAll();
                                            $data111 = $data111[0];
                                            echo '<div class="popup text-center" id="popup">
                                            <div class="body arrondi4">
                                                <div class="p-5">
                                                    <div class="form-group p-2 mt-4">
                                                        <a href="../sortir2.php?update='.$_GET['rs'].'&user='.$a.'&NumCle='.$data111['Intitule'].'" class="btn btn-outline-danger mx-3" id="valider">Sortir</a>
                                                        <a href="../attente2.php?update='.$_GET['rs'].'&user='.$a.'&NumCle='.$data111['Intitule'].'" class="btn btn-outline-warning mx-3" id="attente">En transit</a>
                                                        <a href="clecommun.php?rs='.$_GET['rs'].'&rentrer=1" class="btn btn-outline-sucess mx-3" id="rentrer">Rentrer</a>
                                                    </div>
                                                    <div><a href="clecommun.php?rs='.$_GET['rs'].'&annuler=1" class="btn btn-outline-primary mx-3" id="annuler">Annuler</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                            </div>';
