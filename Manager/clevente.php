                            ...
                            <tbody class="bg-tableau">
                                ...
                                <?php
                                    ...
                                    foreach($data as $row){
                                        ...
                                        echo"<td class='text-center'><a href='../Vente.php?update=".$row['id']."&cle=".$row['Quantite']."&ncop=".$row['Copro']."&cl=".$row['Client']."&ag=".$row['Agence']."&prix=".$row['Prix']."&num=".$row['NumCle']."&mail=".$row['Mail']."&nmcoll=".$row['Utilisateur']."&note=".$row['Note']."&date=".$row['Date']."&contact=".$row['Contact']."&regle=".$row['Reglement']."'><img src='../image/Edit.png' width='30px'></a></td>";
