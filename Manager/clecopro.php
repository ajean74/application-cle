...
<head>
    ...
    <title>Clé de Copropriétaire</title>
</head>
...
<body class="body">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav justify-content-end">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active black" href="clecopro.php">Clé de Copropriétaires</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid">
        <form method="POST" action="clecopro.php">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="ajout-button">
                        <a href="../Cle.php" class="btn btn-outline-primary">Ajouter une clé</a>
                    </div>
                    ...
                    <!-- Affichage des clés 
                        ...
                        MODIFIER LE SYSTEME D'ENREGISTREMENT    
                    -->
                        ...
                        <div class="table-responsive" id="areaToPrint">
                            <table id="exemple" class="table table-bordered cell-border table-striped" style="width:95%">
                                ...
                                <tbody>
                                    ...
                                    $data = $db->query("SELECT * FROM Cle")->fetchAll();
                                    ...
                                    foreach($data as $row){
                                        ...
                                        foreach($data5 as $loc){
                                            if($row['Agence'] == $loc['id']){
                                                if($row['Etat'] == 2){
                                                    foreach($data6 as $user){
                                                        if($row['Utilisateur'] == $user['id']){
                                                            echo "<a class='black' href='clecopro.php?info=".$row['id']."&1=".$row['NomPersonne']."&2=".$row['Date']."&3=".$row['Contact']."&4=".$user['Prenom']."&5=".$row['DateRetour']."&8=".$row['Note']."'>".$loc['Nom']."</a>";
                                                        }
                                                    }
                                                ...
                                                elseif($row['Etat'] == 3){
                                                    foreach($data6 as $user){
                                                        if($row['Utilisateur'] == $user['id']){
                                                            echo "<a class='black' href='clecopro.php?note=".$row['id']."&1=".$row['NomPersonne']."&2=".$row['Date']."&3=".$row['Contact']."&4=".$user['Prenom']."&5=".$row['Note']."&6=".$row['DateRetour']."'>".$loc['Nom']."</a>";
                                                        }
                                                    }
                                        ...
                                        echo"</td>";
                                        echo"<td class='text-center'><div><a href='clecopro.php?rs=".$row['id']."'><input class='btn btn-outline-primary' name='lebouton' type='button' value='Interagir' id='Sortir'></a></div></td>";

                                        echo"<td class='text-center'><a href='../Historique.php?update=".$row['id']."&cle=".$row['NumCle']."'><img src='../image/histo.png' width='30px'></a></td>";

                                        echo"<td class='text-center'><a href='../Cle.php?update=".$row['id']."&cle=".$row['NumCle']."&ncop=".$row['Copro']."&cl=".$row['Client']."&ag=".$row['Agence']."&pj=".$row['Photo']."'><img src='../image/Edit.png' width='30px'></a></td>";

                                        echo"<td class='text-center'><a href='clecopro.php?delete=".$row['id']."'><img src='../image/Poubelle.png' width='30px'></a></td></tr>";
                                        ...
                                        if (isset($_GET['info'])){
                                                    ...
                                                    <div class="body arrondi7 p-3">
                                                       <div>
                                                        ...
                                                        <div class="form-group">
                                                            <a href="clecopro.php?info='.$_GET['info'].'&annuler=1" class="btn btn-outline-primary mx-3" id="annuler">Annuler</a>
                                                        </div>
                                                    </div>
                                                </div>';
                                            ...
                                            if(isset($_GET['annuler'])){
                                                if($_GET['annuler'] == 1){
                                                    ...
                                                    window.location.replace("clecopro.php");</script>';
                                                }
                                            }
                                        }
                                        ...
                                        if (isset($_GET['note'])){
                                            echo '<div class="popup text-center" id="popup">
                                                    <div class="body arrondi7 p-3">
                                                        ...
                                                        <div class="form-group">
                                                            <a href="clecopro.php?info='.$_GET['info'].'&annuler=1" class="btn btn-outline-primary btn-annuler mx-3" id="annuler">Annuler</a>
                                                        </div>
                                                    </div>
                                                </div>';
                                            echo '<script src="../js/index.js"></script>';
                                        ...
                                        if (isset($_GET['delete'])){
                                            ...
                                            <a href="clecopro.php?delete='.$_GET['delete'].'&valider=1" class="btn btn-outline-primary mx-3" id="valider">Supprimer</a>
                                            <a href="clecopro.php?delete='.$_GET['delete'].'&annuler=1" class="btn btn-outline-primary mx-3" id="annuler">Annuler</a>
                                            </div>
                                            </div>
                                            </div>';
                                            echo '<script src="../js/index.js"></script>';
                                            if(isset($_GET['valider'])){
                                                if($_GET['valider'] == 1){
                                                    $idUser = $_GET['delete'];
                                                    $db = new PDO('mysql:host=clesgrn1.mysql.db;dbname=clesgrn1;charset=utf8mb4', 'clesgrn1', 'Grosset74');
                                                    $stmt = $db->prepare("DELETE FROM Cle WHERE id = :idUserDelete");
                                    ...
                                    /* --- Bouton Interagir ---*/
                                        ...
                                        if (isset($_GET['rs'])){
                                            $id2 = $_GET['rs'];
                                            $data111 = $db->query("SELECT * FROM Cle WHERE id = $id2")->fetchAll();
                                            $data111 = $data111[0];
                                            echo '<div class="popup text-center" id="popup">
                                            <div class="body arrondi4">
                                                <div class="p-5">
                                                    <div class="form-group p-2 mt-4">
                                                        <a href="../sortir.php?update='.$_GET['rs'].'&user='.$a.'&NumCle='.$data111['NumCle'].'" class="btn btn-outline-danger mx-3" id="valider">Sortir</a>
                                                        <a href="../attente.php?update='.$_GET['rs'].'&user='.$a.'&NumCle='.$data111['NumCle'].'" class="btn btn-outline-warning mx-3" id="attente">En transit</a>
                                                        <a href="clecopro.php?rs='.$_GET['rs'].'&rentrer=1" class="btn btn-outline-sucess mx-3" id="rentrer">Rentrer</a>
                                                    </div>
                                                    <div><a href="clecopro.php?rs='.$_GET['rs'].'&annuler=1" class="btn btn-outline-primary mx-3" id="annuler">Annuler</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                            </div>';
                                            ...
                                            elseif(isset($_GET['rentrer'])){
                                                if($_GET['rentrer'] == 1){
                                                    ...
                                                    $id = $_GET['rs'];
                                                    $db = new PDO('mysql:host=clesgrn1.mysql.db;dbname=clesgrn1;charset=utf8mb4', 'clesgrn1', 'Grosset74');
                                                    $stmt = $db->prepare("UPDATE Cle SET Etat = :_statut WHERE id= :_id;");
                                                    $stmt->bindParam(':_statut', $statut);
                                                    $stmt->bindParam(':_id', $id);
                                                    $stmt->execute();

                                                    $data21 = $db->query("SELECT * FROM Cle WHERE id = $id")->fetchAll();
                                                    $data21 = $data21[0];
