...
<body class="body">
    <div class="text-center container-fluid">
        ...
        <div class="container">
            <form class="box-update2 arrondi2"  action="<?php echo isset($_GET['update']) ? '' : 'sortir3.php' ?>" method="POST" enctype="multipart/form-data" id="myForm">
                ...
                if(isset($_POST['valider'])){
                    ...
                    $headers .= 'Cc: '.$copie."\n";   
                    $message = 'La clé : '.$mailnum.' vient de sortir du coffre.';
